...
#header[Samuel Martineau][
  ...
  #icon("email") #link("mailto:s83marti@uwaterloo.ca")
][
...
== University of Waterloo
#description[Undergraduate Researcher][Summer 2026 (Ongoing)]
...
== INKAS Industries
#description[Applied Science Researcher][Winter 2026]
Helped kickstart a new drone research and development department, at the intersection of software and hardware~#sep~Led hardware procurement~#sep~Designed project plans based on governmental agency requirements~#sep~Collaborated on software connecting modern artificial intelligence with verifiable reasoning

== Solana Foundation
#description[Software Developer (independent contractor)][Fall 2025]
Led a team of four through the development of the first feature-complete software development kit for the Solana Blockchain on Swift~#sep~Ensured idiomatic design and alignment with core tenets of iOS platform~#sep~Developed a variety of low-level libraries for fast interaction with the blockchain

== Wolfram Research
#description[Student Ambassador (volunteer)][2023 --- Present]
Built a variety of technical demonstrations of the Wolfram platform, mainly Mathematica, in multiple fields, including visualizations of chemical and physical phenomena targeted at high school students #sep Introduced Mathematica, and provided technical support, to peers in local community
